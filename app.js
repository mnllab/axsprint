const STORAGE_KEY = 'ax-sprint-control-tower-v5';
const LEGACY_STORAGE_KEY = 'ax-sprint-control-tower-v4';
...
function loadState(){
  try {
    ...
    const data=saved ? JSON.parse(saved) : clone(window.INITIAL_DATA);
