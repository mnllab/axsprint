window.INITIAL_DATA = {
  "project": {
    ...
    "asOf": "2026-08-31",
    "version": "MVP v5",
    "completionCriteriaBasis": "사업수행계획서 성과지표·산출물·추진일정 및 사용자가 제공한 마일스톤 자료 기준"
  },
  "institutions": [
    {
      "name": "정션메드",
  ...
  "actions": [
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "기관별 실증 데이터 형식과 수집 기준을 최종 통합하고 데이터 표준화 결과 및 표준 지침·운영 매뉴얼을 정리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "표준화 가능성",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "대상 실증기관에 상담 키오스크를 설치하고 상담 전 본인확인·건강상태 측정·상담동의·음성 구조화·자동보고서 기능의 현장 운영을 개시한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "키오스크 실증 운영 로그와 기관별 사용 횟수·자동보고서 생성 건수를 지속 수집하고 운영 이슈를 관리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "B2B/B2G대상 실증",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "실증 초기 데이터의 수집 현황을 기관·대상자·데이터 건수 기준으로 집계하고 누락·형식·품질 이슈를 점검한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "현장 종사자 및 수혜자 대상 만족도·수용성 조사 참여를 지원하고 조사자료 회수 및 결과 집계에 필요한 자료를 확보한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "KOLAS 공인 시험기관 성능시험을 완료하고 감정 분류 등 대상 성능의 시험 결과서를 확보한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "(가중치)AI 감정 분석 성능 검증",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "성과지표 달성 결과와 기관별 수행내용·산출물·증빙을 취합하여 최종보고서를 작성하고 제출한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "기관별 수집 데이터의 항목·형식·레이블 기준을 통합하고 정합성 및 품질 점검 기준을 적용한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "실증 참여기관과 대상자 모집·온보딩을 진행하고 기관별 담당자, 대상자, 적용 채널 및 운영 준비상태를 확인한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "리빙랩 운영 규모",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "표준 척도와 AI 결과의 중간 데이터를 확보하여 상관관계·내적 일치도 등 타당도·신뢰도 분석을 수행하고 중간 검증 결과를 정리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "케어원·상담센터·키오스크·케어콜 채널의 실증을 계획 기간 동안 운영하고 기관·대상자·사용·데이터 실적을 누적 관리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "리빙랩 운영 규모",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "실증 운영을 종료하고 기관별 운영실적, 대상자, 사용건수, 데이터, 이슈 및 후속조치 내용을 결과자료로 정리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "리빙랩 운영 규모",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "중간 시점의 기관별 수집 데이터 형식·레이블·정합성 상태를 점검하고 표준화 보완사항 및 조치계획을 정리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "표준화 가능성",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "현장 종사자와 수혜자 대상 사용자 수용성·조작 용이성·지속 활용 의향 조사를 실시하고 결과 데이터를 확보한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "(가중치)사용자 수용성",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "마음로그·케어원·키오스크·케어콜의 수집 항목과 비식별 처리 기준을 정의하고 음성·생체·검사·일기 데이터 수집 체계를 구축한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "음성·생체 데이터 수집 및 비식별 처리 체계 구축",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "실증기관별 운영결과와 성과지표 측정자료를 취합하고 사용자 수용성·현장 적용성·실증 전후 변화 등 성과분석 결과를 정리한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "실증 전후 변화",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "컨소시엄 성과보고회를 개최하고 주요 성과, 성과지표 달성 결과, 산출물 및 향후 확산계획을 공유한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "케어콜 기반 고령자 실증을 개시하고 상담·특이사항 자동입력 등 서비스 사용 이력을 수집하기 시작한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "실증 데이터의 수집 항목, 형식, 레이블, 비식별 처리 및 품질관리 기준을 문서화하고 기관 공통 적용기준을 수립한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "표준화 가능성",
    ...
    },
    {
      ...
      "status": "예정",
      "priority": "보통",
      "completionCriteria": "AI 서비스 1차 고도화 기능을 적용하고 감정분석·음성인식·위험신호·보고서 등 주요 기능의 내부 테스트를 완료한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "(가중치)AI 감정 분석 성능 검증",
    ...
    },
    {
      ...
      "status": "진행 중",
      "priority": "보통",
      "completionCriteria": "실증 전후 변화, 사용자 수용성, 현장 적용성 측정에 필요한 설문 문항과 조사방식을 검토하고 최종 설문안을 확정한 상태",
      "evidence": "",
      "blocker": "",
      "pmCheck": false,
      "relatedKpi": "실증 전후 변화",
